...
class DocumentComparatorLLM:
    ...
    def compare_documents(self,combined_docs:str)-> pd.DataFrame:
        """
        Compares two documents and returns a strucured comparison.
        """
        try:
            inputs = {
            ...
            self.log.info("Starting document comarison", inputs=inputs)
            response = self.chain.invoke(inputs)
            self.log.info("Document comparidon completed", response=response)
