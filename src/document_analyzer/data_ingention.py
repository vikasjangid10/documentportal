...
class DocumentHandler:
    ...
    def save_pdf(self,uploaded_file):
        try:
            ...
            self.log.info("PDF saved successfully", file = filename, seve_path=save_path, session_id=self.session_id)
            return save_path
        except Exception as e:
...
if __name__ == "__main__":
    ...
    pdf_path = "D:\\gen ai projects\\langchain and its projects\\documentportal\\data\\document_analysis\\NIPS-2017-attention-is-all-you-need-Paper.pdf"
